    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseAuthListener=new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user!=null){
                    Intent intent = new Intent(CostomerLoginActivity.this,MapActivity.class);
        ...
        mRegistration.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener
                        (CostomerLoginActivity.this, new OnCompleteListener<AuthResult>() {
                            @Override
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (!task.isSuccessful()){
                                    Toast.makeText(CostomerLoginActivity.this,"Sign up error",Toast.LENGTH_SHORT).show();
                                }else {
